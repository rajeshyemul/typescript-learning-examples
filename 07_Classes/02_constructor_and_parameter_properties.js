...
// --------------------------------------------------
var UserTraditional = /** @class */ (function () {
    function UserTraditional(name, experience) {
        this.name = name;
        this.experience = experience;
    }
    UserTraditional.prototype.getDetails = function () {
        return "".concat(this.name, " has ").concat(this.experience, " years of experience");
    };
    return UserTraditional;
}());
var user1 = new UserTraditional("Rajesh", 15);
...
var UserWithParameterProperties = /** @class */ (function () {
    function UserWithParameterProperties(name, experience) {
        this.name = name;
        this.experience = experience;
    }
    UserWithParameterProperties.prototype.getDetails = function () {
        return "".concat(this.name, " has ").concat(this.experience, " years of experience");
    };
    return UserWithParameterProperties;
}());
var user2 = new UserWithParameterProperties("Amit", 10);
